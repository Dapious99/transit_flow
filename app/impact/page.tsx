...
const impactMetrics = [
  {
    ...
    description: 'Beta goal: reduce operational costs by 40% for fleet operators through AI routing and fuel waste elimination.',
  },
  {
    icon: Users,
    value: '3+',
    label: 'Pilot Partners',
    description: 'Logistics companies in Lagos confirmed for our closed beta programme, with more joining each month.',
  },
  {
    icon: Truck,
    value: '50+',
    label: 'Beta Applicants',
    description: 'Fleet operators across Nigeria on our waitlist, eager to be among the first to use TransitFlow.',
  },
  {
    icon: Leaf,
    value: '35%',
    label: 'Target Carbon Reduction',
    description: 'Beta goal: reduce fleet carbon emissions through AI-optimised routing and eco-driving recommendations.',
  },
  {
    icon: Globe,
    value: '10+',
