...
const founders = [
  {
    ...
    quote:
      "We built TransitFlow because we lived the problem. Nigerian logistics operators deserve world-class tools built specifically for African roads, traffic, and business realities.",
  ...
  },
  {
    ...
    quote:
      "The AI we've built isn't a generic product pasted onto African roads. It was trained on Nigerian traffic data, Nigerian road conditions, and Nigerian logistics patterns. That specificity is our edge.",
      ...
      <div className="container mx-auto px-4 md:px-6">
        ...
        >
          ...
          <p className="text-muted-foreground mt-4 text-base max-w-2xl mx-auto">
            TransitFlow was founded by logistics and AI experts with firsthand
            experience of Nigeria&apos;s transportation challenges — not
            consultants who read about it.
          </p>
        </motion.div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 max-w-5xl mx-auto">
          {founders.map((founder, index) => (
            ...
            >
              {/* Avatar section */}
              <div
                className={`h-52 flex items-center justify-center relative bg-linear-to-br ${founder.gradientFrom} ${founder.gradientTo}`}
              >
                <div className="w-44 h-44 drop-shadow-xl">
                  {founder.avatar === "ceo" ? <CEOAvatar /> : <CTOAvatar />}
                </div>
                <span
                  className={`absolute top-4 right-4 text-xs font-bold px-3 py-1 rounded-full ${founder.badgeClass}`}
                >
                  {founder.badge}
                </span>
              </div>
              ...
              <div className="p-7">
                <div className="flex items-start justify-between mb-4">
                  <div>
                    ...
                    <p
                      className={`text-sm font-medium mt-1 ${founder.roleClass}`}
                    >
                      {founder.role}
                    </p>
                  </div>
                  <div className="flex gap-3 mt-0.5 ml-4 shrink-0">
                ...
                <blockquote
                  className={`border-l-2 pl-4 ${founder.quoteAccent}`}
                >
                  <svg
                    width="16"
                    height="12"
                  ...
                  >
                    <path
                      d="M0 12V7.2C0 3.2 2.4 0.8 7.2 0L8 1.6C5.6 2.4 4.4 3.6 4.4 5.2H7.2V12H0ZM8.8 12V7.2C8.8 3.2 11.2 0.8 16 0L16.8 1.6C14.4 2.4 13.2 3.6 13.2 5.2H16V12H8.8Z"
                      fill="currentColor"
