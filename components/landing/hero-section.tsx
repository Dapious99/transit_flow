...
import { HeroCityIllustration } from '@/components/illustrations/hero-city-illustration'
    ...
    <section className="relative min-h-screen flex flex-col items-center justify-center overflow-hidden pt-20 pb-16">
      ...
      <div className="absolute inset-0 overflow-hidden">
        ...
        <svg className="absolute inset-0 w-full h-full opacity-20" xmlns="http://www.w3.org/2000/svg">
          ...
          <motion.path d="M0,200 Q400,100 800,200 T1600,200" fill="none" stroke="url(#line-gradient)" strokeWidth="2"
            initial={{ pathLength: 0 }} animate={{ pathLength: 1 }}
            transition={{ duration: 3, repeat: Infinity, repeatType: 'loop' }} />
          <motion.path d="M0,400 Q400,300 800,400 T1600,400" fill="none" stroke="url(#line-gradient)" strokeWidth="2"
            initial={{ pathLength: 0 }} animate={{ pathLength: 1 }}
            transition={{ duration: 3.5, repeat: Infinity, repeatType: 'loop', delay: 0.5 }} />
          <motion.path d="M0,600 Q400,500 800,600 T1600,600" fill="none" stroke="url(#line-gradient)" strokeWidth="2"
            initial={{ pathLength: 0 }} animate={{ pathLength: 1 }}
      ...
      <div className="container mx-auto px-4 md:px-6 relative z-10">
        <div className="max-w-5xl mx-auto text-center">
          ...
          <motion.div initial={{ opacity: 0, y: 30 }} animate={{ opacity: 1, y: 0 }}
            ...
            <Button size="lg" className="bg-primary hover:bg-primary/90 text-primary-foreground font-semibold px-8 py-6 text-base rounded-full glow-primary">
              <Link href="/contact" className="flex items-center">
                Get Started Today
                <ArrowRight className="ml-2 w-5 h-5" />
              </Link>
            </Button>
            <Button variant="outline" size="lg" className="border-border hover:bg-secondary text-foreground font-semibold px-8 py-6 text-base rounded-full">
        ...
        <motion.div initial={{ opacity: 0, y: 50 }} animate={{ opacity: 1, y: 0 }}
          ...
          <div className="relative rounded-2xl overflow-hidden border border-primary/20 shadow-2xl shadow-primary/10 aspect-[1100/460]">
            <HeroCityIllustration />
          </div>
          <p className="text-center text-xs text-muted-foreground mt-4">
            Smart trucks on Nigerian roads · Live GPS tracking · Real-time driver HUD
          </p>
        </motion.div>
      </div>
    </section>
